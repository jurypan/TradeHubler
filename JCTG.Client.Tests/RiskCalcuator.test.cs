...
namespace JCTG.Client.Tests
{
    public class RiskCalculatorTest
    {
        ...
        public void LotSize_CalculatesCorrectly()
        {
            ...
            // Act
            decimal result = Calculator.LotSize(startBalance, balance, risk, askPrice, slPrice, tickValue, tickSize, lotStep, minLotSize, maxLotSize, 0, true, out _, riskData);
        ...
        public void CalculateLotSize_ValidInputs_CorrectCalculation1()
        {
            ...
            // Act
            var result = Calculator.LotSize(startBalance, accountBalance, riskPercent, openPrice, stopLossPrice, tickValue, tickSize, lotStep, minLotSizeAllowed, maxLotSizeAllowed, 0, true, out _);
        ...
        public void CalculateLotSize_WithValidInputs_ReturnsCorrectLotSize()
        {
            ...
            // Act
            var result = Calculator.LotSize(startBalance, accountBalance, riskPercent, askPrice, stopLossPrice, tickValue, pointSize, lotStep, minLotSizeAllowed, maxLotSizeAllowed, 0, true, out _);
        ...
        public void CalculateLotSize_WithNegativeBalance_ThrowsArgumentException()
        {
            ...
            // Act
            var result = Calculator.LotSize(startBalance, accountBalance, 1M, 1.3000M, 1.2900M, 10M, 0.0001M, 0.01, 0.01, 100, 0, true, out _);
        ...
        public void CalculateLotSize_WithZeroBalance_ReturnZeroLots()
        {
            ...
            // Act
            var result = Calculator.LotSize(startBalance, accountBalance, 1M, 1.3000M, 1.2900M, 10, 0.0001M, 0.01, 0.01, 100, 0, true, out _);
        ...
        public void LotSize_ShouldReturnZero_WhenAccountBalanceIsNegative()
        {
            ...
            // Act
            decimal result = Calculator.LotSize(startBalance, accountBalance, riskPercent, openPrice, stopLossPrice, tickValue, tickSize, lotStep, minLotSizeAllowed, maxLotSizeAllowed, 0, true, out _);
        ...
        public void GetClosestRiskPercentage_WithPositiveBalance_ReturnsCorrectAdjustedRisk()
        {
            ...
            var result = Calculator.ChooseClosestMultiplier(startBalance, accountBalance, riskData);
